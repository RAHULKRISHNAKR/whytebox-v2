...
class MetricsCollector:
    ...
    def __init__(self, max_history: int = 1000):
        ...
        self.explainability_times: Dict[str, deque] = defaultdict(lambda: deque(maxlen=max_history))

        # Cache metrics (updated externally)
        self.cache_stats: Dict[str, int] = {"hits": 0, "misses": 0, "sets": 0}
    ...
    def record_inference(self, model_id: str, duration: float):
        ...
        self.inference_times[model_id].append(
            {"duration": duration, "timestamp": datetime.utcnow()}
        )
    ...
    def get_endpoint_stats(self) -> List[Dict[str, Any]]:
        ...
        for endpoint, count in self.request_counts.items():
            endpoint_requests = [r for r in self.request_times if r["endpoint"] == endpoint]
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {**self.cache_stats, "total_requests": total, "hit_rate": round(hit_rate, 2)}
    ...
    def check_health(self) -> Dict[str, Any]:
        ...
        if request_stats["total_requests"] > 0:
            ...
            if request_stats["avg_duration_ms"] > self.thresholds["avg_response_time_ms"]:
                warnings.append(f"Slow response time: {request_stats['avg_duration_ms']}ms")
        ...
        return {
            ...
            "metrics": {"requests": request_stats, "system": system_stats},
        }
