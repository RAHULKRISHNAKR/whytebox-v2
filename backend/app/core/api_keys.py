...
class APIKeyManager:
    ...
    def validate_key(self, plain_key: str, required_scopes: Optional[List[str]] = None) -> APIKey:
        """
...
async def get_api_key(
    api_key: Optional[str] = Depends(api_key_header), required_scopes: Optional[List[str]] = None
) -> Optional[APIKey]:
    """
