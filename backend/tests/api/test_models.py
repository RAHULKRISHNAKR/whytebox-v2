...
class TestModelsAPI:
    ...
    async def test_list_models_pagination(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get("/api/v1/models/?page=1&page_size=5", headers=auth_headers)
    ...
    async def test_list_models_filter_by_framework(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get("/api/v1/models/?framework=pytorch", headers=auth_headers)
    ...
    async def test_list_models_filter_by_type(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get("/api/v1/models/?type=cnn", headers=auth_headers)
    ...
    async def test_get_model_success(
        self, client: AsyncClient, auth_headers: dict, sample_model_data: dict
    ):
        """Test getting a specific model."""
        # First create a model (mock)
        model_id = "vgg16"

        response = await client.get(f"/api/v1/models/{model_id}", headers=auth_headers)
    ...
    async def test_get_model_not_found(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.get("/api/v1/models/nonexistent_model", headers=auth_headers)
    ...
    async def test_load_model_success(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.post(
            "/api/v1/models/load", headers=auth_headers, json={"model_id": "vgg16", "device": "cpu"}
        )
    ...
    async def test_load_model_invalid_device(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.post(
            ...
            json={"model_id": "vgg16", "device": "invalid_device"},
        )
    ...
    async def test_load_model_missing_model_id(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.post(
            "/api/v1/models/load", headers=auth_headers, json={"device": "cpu"}
        )

        assert response.status_code == 422

    async def test_upload_model_success(
        self, client: AsyncClient, auth_headers: dict, mock_model_file
    ):
    ...
    async def test_upload_model_missing_file(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.post(
            "/api/v1/models/upload",
            headers=auth_headers,
            data={"name": "Test Model", "type": "cnn", "framework": "pytorch"},
        )

        assert response.status_code == 422

    async def test_upload_model_invalid_framework(
        self, client: AsyncClient, auth_headers: dict, mock_model_file
    ):
        ...
        with open(mock_model_file, "rb") as f:
            response = await client.post(
                ...
                headers=auth_headers,
                files={"file": ("test_model.pth", f, "application/octet-stream")},
                data={"name": "Test Model", "type": "cnn", "framework": "invalid_framework"},
            )
    ...
    async def test_delete_model_success(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.delete(f"/api/v1/models/{model_id}", headers=auth_headers)
    ...
    async def test_delete_model_not_found(self, client: AsyncClient, auth_headers: dict):
        ...
        response = await client.delete("/api/v1/models/nonexistent_model", headers=auth_headers)
...
class TestModelsIntegration:
    ...
    async def test_model_lifecycle(self, client: AsyncClient, auth_headers: dict, mock_model_file):
        ...
        # 3. Get model details
        get_response = await client.get(f"/api/v1/models/{model_id}", headers=auth_headers)
        assert get_response.status_code == 200

        # 4. Delete model
        delete_response = await client.delete(f"/api/v1/models/{model_id}", headers=auth_headers)
        assert delete_response.status_code == 200

        # 5. Verify deletion
        verify_response = await client.get(f"/api/v1/models/{model_id}", headers=auth_headers)
    ...
    async def test_concurrent_model_loads(self, client: AsyncClient, auth_headers: dict):
        ...
        responses = await asyncio.gather(
            *[load_model(mid) for mid in model_ids], return_exceptions=True
        )
