...
class TestModelAPI:
    ...
    def test_create_model(self, client: TestClient, auth_headers: dict, mock_model_file: str):
    ...
    def test_list_models(self, client: TestClient, auth_headers: dict, test_model: Model):
        """Test listing models"""
    ...
    def test_get_model(self, client: TestClient, auth_headers: dict, test_model: Model):
        """Test getting a specific model"""
        response = client.get(f"/api/v1/models/{test_model.id}", headers=auth_headers)
    ...
    def test_update_model(self, client: TestClient, auth_headers: dict, test_model: Model):
    ...
    def test_delete_model(self, client: TestClient, auth_headers: dict, test_model: Model):
        ...
        response = client.delete(f"/api/v1/models/{test_model.id}", headers=auth_headers)
...
class TestTaskAPI:
    ...
    def test_submit_inference_task(
        self, client: TestClient, auth_headers: dict, test_model: Model, sample_input_data: dict
    ):
        """Test submitting an inference task"""
        response = client.post(
            "/api/v1/tasks/inference",
            headers=auth_headers,
            json={"model_id": test_model.id, "input_data": sample_input_data},
        )
    ...
    def test_submit_batch_inference_task(
        ...
        response = client.post(
            ...
            headers=auth_headers,
            json={"model_id": test_model.id, "batch_data": [sample_input_data, sample_input_data]},
        )
    ...
    def test_get_task_status(self, client: TestClient, auth_headers: dict):
        ...
        response = client.get("/api/v1/tasks/test_task_id", headers=auth_headers)
...
class TestAdminAPI:
    ...
    def test_create_api_key(self, client: TestClient, admin_headers: dict):
        ...
        response = client.post(
            ...
            json={"name": "Test API Key", "scopes": ["read", "inference"], "expires_in_days": 90},
        )
    ...
    def test_get_system_config(self, client: TestClient, admin_headers: dict):
    ...
    def test_admin_only_access(self, client: TestClient, auth_headers: dict):
...
class TestErrorHandling:
    ...
    def test_error_has_request_id(self, client: TestClient, auth_headers: dict):
...
class TestHealthCheck:
    ...
    def test_detailed_health_check(self, client: TestClient, admin_headers: dict):
        """Test detailed health check (admin only)"""
        response = client.get("/api/v1/admin/health/detailed", headers=admin_headers)
...
class TestAPIIntegration:
    ...
    def test_complete_model_workflow(
        self, client: TestClient, auth_headers: dict, mock_model_file: str, sample_input_data: dict
    ):
        ...
        response = client.post(
            "/api/v1/tasks/inference",
            headers=auth_headers,
            json={"model_id": model_id, "input_data": sample_input_data},
        )
        assert response.status_code == 202
